...
class CustomerFilter(django_filters.FilterSet):
    ...
    created_at_gte = django_filters.DateFilter(field_name='id', lookup_expr='gte')  # or created_at if exists
    created_at_lte = django_filters.DateFilter(field_name='id', lookup_expr='lte')  # placeholder
